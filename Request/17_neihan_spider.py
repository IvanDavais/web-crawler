...
class Neihan:
    ...
    def get_first_page_list(self,html_str): #提取第一页的数据
    ...
    def get_content_list(self,json_str): # 提取从第二页开始的json数据
    ...
    def run(self):
        ...
        # 3.提取数据
        content_list,max_time = self.get_first_page_list(html_str)
        # 4.保存
