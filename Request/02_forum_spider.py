...
class ForumSpider:
    def __init__(self,forum_name):
        ...
        self.url_temp = "https://tieba.baidu.com/f?kw="+ self.forum_name+ "&ie=utf-8&pn=50"
        self.headers = {"User-Agent":"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"}
